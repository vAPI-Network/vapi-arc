...
const statusClass: Record<string, string> = {
  ...
  "Awaiting sponsorship": "status-pending",
  "Sponsorship unknown": "status-neutral",
  "Payment accepted": "status-pending",
  Dispatched: "status-pending",
  Claimed: "status-pending",
  "Verdict submitted": "status-pending",
  "Auditor paid": "status-completed",
  "Escrow settled": "status-completed",
  "Review expired": "status-rejected",
  "Payer refunded": "status-neutral",
  "Payout failed": "status-rejected",
  "Settlement retrying": "status-rejected",
  Open: "status-neutral",
